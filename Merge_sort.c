/*  write an open mp program to sort an array of n elements using both sequential and parallel merge sort using the sections directives . 
    Record and print the difference in execution time between the two methods. */
